                  ...
                  >
                    <div id="mc_embed_signup_scroll" class="flex w-full">
                      ...
                      <input
                        ...
                        class="px-4 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-base font-medium rounded-r-full hover:from-amber-400 hover:to-amber-500 transition-all duration-200"
                        value="Subscribe"
                        role="button"
